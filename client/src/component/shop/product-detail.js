                                ...
                                <TabPane tabId="1">
                                        <div className="tab-content" id="myTabContent">
                                                ...
                                                <div className="product-info-box border-top border-bottom mt-5  pt-4 pt-lg-0 pb-2 pb-sm-0">
                                                    <Row>
                                                    <Col sm={6} md={4}>
                                                        <div className="moderncover_info_box_2 moderncover_info_box_2-layout-style_2 moderncover_info_box_2-content_alignment-left moderncover_info_box_2-with-icon moderncover_info_box_2-icon-source-font  moderncover_info_box_2-icon-size-md  moderncover_info_box_2-icon_position-left icon-left-spacing">
                                                        <div className="moderncover_info_box_2-inner clearfix align-items-center">
                                                            ...
                                                            <div className="moderncover_info_box_2-content-wrap">
                                                                ...
                                                                <h6 className="moderncover_info_box_2-title inline_hover">Free shipping </h6>
                                                                <div className="moderncover_info_box_2-content">
                                                    ...
                                                    <Col sm={6} md={4}>
                                                        ...
                                                        <div className="moderncover_info_box_2-inner clearfix align-items-center">
                                                            ...
                                                            <div className="moderncover_info_box_2-content-wrap">
                                                                <div className="moderncover_info_box_2-content-inner">
                                                                <h6 className="moderncover_info_box_2-title inline_hover">30 Days Return </h6>
                                                                <div className="moderncover_info_box_2-content">
